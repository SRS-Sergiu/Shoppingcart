...
<form action="cos1.php?actiune=modifica" method="POST">
...
?>
		...
		<input type="submit" value="Modifică"> <br><br> Introduceţi <b>0</b> pentru cărţile pe care doriţi să le scoateţi din coş!
					...
					<a href="index.php"><img src="cumpara.jpg" height="50px" width="50px">Continuă cumpărăturile </a></td>
					
					<td width="200" align="center"><a href="casa.php"><img src="plateste.jpg" height="50px" width="50px"><br>Mergi la casă</a></td>
